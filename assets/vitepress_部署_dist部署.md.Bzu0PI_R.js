import{_ as a,c as n,o as e,ag as t}from"./chunks/framework.oP1PDRBo.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vitepress/部署/dist部署.md","filePath":"vitepress/部署/dist部署.md","lastUpdated":1772415502000}'),p={name:"vitepress/部署/dist部署.md"};function i(l,s,c,o,g,d){return e(),n("div",null,s[0]||(s[0]=[t(`<h2 id="部署到github-pages" tabindex="-1">部署到GitHub Pages <a class="header-anchor" href="#部署到github-pages" aria-label="Permalink to &quot;部署到GitHub Pages&quot;">​</a></h2><p>既然要部署到GitHub Pages，你得先在github新建一个仓库，因为要用他的GitHub Pages，所以仓库命名为username.github.io的形式，username是你github的用户名。然后点击设置</p><h3 id="选择pages" tabindex="-1">选择pages <a class="header-anchor" href="#选择pages" aria-label="Permalink to &quot;选择pages&quot;">​</a></h3><p>这里采用的是<code>Github Page</code>来进行部署，值得注意的是，如果要用<code>Github Page</code>来部署，那么需要在<code>git</code>上的仓库需要是<code>public</code>状态哦~</p><p>这里设置根目录/(root),当然也可以选择其它目录,点击保存，如果选择其它目录比如docs，config.js文件里，就需要配置一个base</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export default {</span></span>
