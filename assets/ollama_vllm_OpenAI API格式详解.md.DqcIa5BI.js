import{_ as n,c as a,o as t,ag as o}from"./chunks/framework.KcKrU9KS.js";const h=JSON.parse('{"title":"OpenAI API格式详解-Chat Completions","description":"","frontmatter":{},"headers":[],"relativePath":"ollama/vllm/OpenAI API格式详解.md","filePath":"ollama/vllm/OpenAI API格式详解.md","lastUpdated":1772416085000}'),p={name:"ollama/vllm/OpenAI API格式详解.md"};function e(l,s,i,u,c,q){return t(),a("div",null,s[0]||(s[0]=[o(`<h1 id="openai-api格式详解-chat-completions" tabindex="-1">OpenAI API格式详解-Chat Completions <a class="header-anchor" href="#openai-api格式详解-chat-completions" aria-label="Permalink to &quot;OpenAI API格式详解-Chat Completions&quot;">​</a></h1><p>在使用兼容OpenAI的API请求模型来完成对话，首先需要指定大模型服务的 <a href="https://zhida.zhihu.com/search?content_id=241983112&amp;content_type=Article&amp;match_order=1&amp;q=BASE_URL&amp;zhida_source=entity" target="_blank" rel="noreferrer">BASE_URL</a> 和 <a href="https://zhida.zhihu.com/search?content_id=241983112&amp;content_type=Article&amp;match_order=1&amp;q=OPENAI_API_KEY&amp;zhida_source=entity" target="_blank" rel="noreferrer">OPENAI_API_KEY</a>，其次是构建request请求体。一个基本的请求/响应的例子：</p><ul><li>request</li></ul><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>curl http://localhost:8000/v1/completions  \\  </span></span>
